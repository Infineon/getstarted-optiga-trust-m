...
1. Click on **Device** to select a target device
    1. Select Infineon as Manufacturer and Device as XMC1404-0200, and then click OK
1. Select hex file (`bin/xmc1400-getstarted-optiga-trust-m.hex`) to be flashed under **Data File** and click on **Program Device**. It then shows the programming progress window.
...
The guidance on how to compile and debug the setup you can find [here](https://github.com/oscarcreativeshop/getstarted-optiga-trust-m/wiki)
