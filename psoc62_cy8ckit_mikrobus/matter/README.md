...
### Platform Setup
Apart from the flashed PSoC62 Pioneer Kit + OPTIGA&trade; Trust M MTR you will need a  Matter enabled Apple Hub (e.g. HomePod Mini, HomePod 2nd Gen) and an iPhone or iPad to connect to the Apple Smart-home Hub.
...
### Add CD to your Google Developer Console
